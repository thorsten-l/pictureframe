...
public class ConsoleClientBeanShell implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      ...
      interpreter.eval("import l9g.app.pictureframe.*;");
      interpreter.eval("import l9g.app.pictureframe.config.*;");
      interpreter.eval("importCommands(\"l9g.app.pictureframe.beanshell\");");
